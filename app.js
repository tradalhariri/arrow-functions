...
let sumUsingArrow = (a,b,c,d) => a+b+c+d;
console.log('sum using arrow function ',sumUsingArrow(1, 2, 3, 4));
...
// Objectlet using arrow function

let objectLitUsingArrow = ()=>({
  key1: 'value1',
  key2: 'value2',
  key3: 'value3',
});

console.log('objectLit using arrow function ',objectLitUsingArrow());
...
// Sum and product using arrow function

let sumAndProductUsingArrow = (a,b) => [a+b,a*b];

console.log('sum and product using arrow function ',sumAndProductUsingArrow(3, 9));
...
console.log('message using arrow function ',messageUsingArrow('Allie'));
///
...
// let StudentUsingArrow = (name, age, hometown) =>{
//   this.name = name;
//   this.age = age;
//   this.hometown = hometown;
// };

// let ali = new StudentUsingArrow('Ali', 'Schmoe', 100);

// console.log(ali);/// Uncaught TypeError: StudentUsingArrow is not a constructorat app.js:201
/////
...
console.log(joe.greetingUsingArrow()); //this.name in the arrow function for this case is returned to the window object
//
...
Student.courseNameUsingArrow = () => 'This student is enrolled in Code 301.';

console.log(Student.courseNameUsingArrow());
...
// this in this case  is the joe object
// 2. What is "this" when joe.scopeArrow() is invoked?
// this in this case  is the window object
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions take the value of this from its lexical scope not from the object or context that calls them.
